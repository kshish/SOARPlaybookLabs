...
def decision_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    add_to_list_add_comment_2(action=action, success=success, container=container, results=results, handle=handle)
...
@phantom.playbook_block()
def add_to_list_add_comment_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug("add_to_list_add_comment_2() called")
    ...
    phantom.comment(container=container, comment="File has not been observed before. Added hash to prior hashes list")
